              ...
              >
                ...
                <div class="flex-auto px-4 lg:px-10 py-10 pt-0">
                  ...
                  <div class="text-center font-bold mb-3" v-show="responseErr">
                    <small class="text-red-600" >Invalid Credentials</small>
                  </div>
...
export default {
  ...
  methods: {
    async login() {
      ...
      const response = await axios.post('http://localhost:7000/auth/login', {email: this.email, password: this.password})
